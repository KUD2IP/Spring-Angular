...
import { uploaadBookCoverPicture } from '../fn/book/uploaad-book-cover-picture';
import { UploaadBookCoverPicture$Params } from '../fn/book/uploaad-book-cover-picture';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `uploaadBookCoverPicture()` */
  static readonly UploaadBookCoverPicturePath = '/books/cover/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `uploaadBookCoverPicture()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploaadBookCoverPicture$Response(params: UploaadBookCoverPicture$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
    return uploaadBookCoverPicture(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `uploaadBookCoverPicture$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploaadBookCoverPicture(params: UploaadBookCoverPicture$Params, context?: HttpContext): Observable<{
}> {
    return this.uploaadBookCoverPicture$Response(params, context).pipe(
